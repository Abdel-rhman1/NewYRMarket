											...
											<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
												<div class="card-header align-items-center  border-bottom-dark px-0">
													<div class="card-title mb-0">
														<h3 class="card-label mb-0 font-weight-bold text-body">Packages
														</h3>
													</div>
																	...
																	<div class="col-lg-4">
																		...
																		<div class="card-body">
																			...
																			@if($package->package_type == 'Free')
																				<h6 class="card-price text-center">{{$package->package_type}}<span class="period"></span></h6>																				
																			@else
																				<h6 class="card-price text-center">{{$package->price}} $<span class="period">/ {{$package->package_type}}</span></h6>
																			@endif
																			<hr>
																			<ul class="fa-ul">
																				...
																				<?php 
																					$i=0; 
																					$package_features = App\Models\Package::find($package->id)->features;
																				?>
																					@foreach ($package_features as $item)
																					@if($item->id == $feature->id )
																					<?php $i=1;?>
																					<li><span class="fa-li"><i class="fas fa-check" style="color: #4CAF50"></i></span>{{$feature->features}}</li>	
																					@endif
																					@endforeach

																					@if($i == 0 )

																					<li class="text-muted"><span class="fa-li"><i class="fas fa-times" style="color: red"></i></span>{{$feature->features}}
																					</li>	
																					@endif
																				@endforeach
																			</ul>
																			<div class="d-grid">
																			<a href="{{route('packages.edit',$package->id)}}" class="btn btn-primary ">Edit Package/Features</a>
																			</div>
																		</div>
																		</div>
																	</div>
