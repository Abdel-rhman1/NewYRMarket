                                                ...
                                                <tbody class="kt-table-tbody text-dark">
                                                    @foreach ( $brand_list as $brand )
                                                        <tr class="kt-table-row kt-table-row-level-0">
                                                            <td><input type="checkbox" name="idp" class="blabla" value="{{$brand->id}}"></td>
                                                            @if($brand->image)
                                                                <td><img src="{{url('public/images/brand', $brand->image)}}" class="h-70px w-70px rounded-sm mr-3"></td>
                                                            @else
                                                                <td><img src="{{url('public/images/brand/zummXD2dvAtI.png')}}" class="h-70px w-70px rounded-sm mr-3"></td>
                                                            @endif
                                                            <td>{{$brand->title}}</td>
                                                            <td>
...
<div id="kt_notes_panel" class="offcanvas offcanvas-right kt-color-panel p-5">
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-3">
        <h4 class="font-size-h4 font-weight-bold m-0">Add Brand 
        </h4>
    ...
    <p class="italic"><small>file.The field labels marked with * are required input fields.</small></p>
