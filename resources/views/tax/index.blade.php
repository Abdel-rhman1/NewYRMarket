        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-white mb-0 px-0 py-2">
                    <li class="breadcrumb-item " aria-current="page">Taxs</li>
                            ...
                            <div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
                                <div class="card-header align-items-center  border-bottom-dark px-0">
                                    <div class="card-title mb-0">
                                        <h3 class="card-label mb-0 font-weight-bold text-body">Taxs
                                        </h3>
                                    </div>
                                            ...
                                            <table id="productUnitTable" class="display ">
                                                ...
                                                <tbody class="kt-table-tbody text-dark">
                                                    ...
                                                    <tr class="kt-table-row kt-table-row-level-0">
                                                        <td><input type="checkbox" name="idp" class="blabla" value="{{$tax->id}}"></td>
                                                            <td>{{$tax->name}}</td>
                                                            <td>{{$tax->rate}}</td>
                                                            <td>
...
<div id="kt_notes_panel" class="offcanvas offcanvas-right kt-color-panel p-5">
    ...
    <form class="form" action="{{route('tax.store')}}" method="POST">
        @csrf
        <div class="row">
            <div class="col-12">
