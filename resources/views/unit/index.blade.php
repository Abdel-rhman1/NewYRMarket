                                            ...
                                            <table id="productUnitTable" class="display ">
                                                ...
                                                <tbody class="kt-table-tbody text-dark">
                                                    ...
                                                    <tr class="kt-table-row kt-table-row-level-0">
                                                        <td><input type="checkbox" name="idp" class="blabla" value="{{$unit->id}}"></td>
                                                        @if ($unit->base_unit)
                                                        <?php $base_unit = DB::table('units')->find($unit->base_unit); ?>
...
<div id="kt_notes_panel" class="offcanvas offcanvas-right kt-color-panel p-5">
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-3">
        <h4 class="font-size-h4 font-weight-bold m-0">Add Unit 
        </h4>
            ...
            <div class="col-12">
                ...
                <div class="form-group">
                    ...
                    <fieldset class="form-group mb-3">
                        <select class="js-example-basic-single js-states form-control bg-transparent" id="base_unit_create" name="base_unit">
